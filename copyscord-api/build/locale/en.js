...
exports.default = {
    ...
    5005: `password too short (min: ${config_1.default.minPasswordLength})`,
    5006: `username too short (min: ${config_1.default.minUsernameLength})`,
    5007: "email invalid",
    ...
    6003: `limit musn't exceed ${config_1.default.maxMessagePerFetch} messages`,
    ...
    9003: `limit of server per users reached (max: ${config_1.default.maxServerPerUser})`,
    9004: `max invite per server reached (max: ${config_1.default.maxInvitePerServer})`,
    9005: `max invite per user on server reached (max: ${config_1.default.maxInvitePerUser})`,
    //Client
    10001: "password required",
    10002: "nothing to update",
    10003: `username too long (max: ${config_1.default.maxUsernameLength})`,
    ...
    //Logo:
    12001: "logo required",
    12002: `logo size musn't exceed ${config_1.default.maxImageSize / 1048576}Mb`,
